                    ...
                    <div class="editpage">
                        <div class="editpageleft">
                            <div class="editpage-input">
                                <label class="editlabel">中文名</label>
                            ...
                            <div class="editpage-input">
                                <label class="editlabel">拉丁文名</label>
                                <input type="text" class="edit-input" />
                            </div>
                            <div class="editpage-input">
                                <label class="editlabel">有效成分和别名</label>
                                <input type="text" class="edit-input" />
                            </div>
                            <div class="editpage-input">
                                <label class="editlabel">采购价格</label>
                                <input type="text" class="edit-input" />
                            </div>
                        </div>
                        <div class="editpageright">
                            <div class="editpage-input">
                                <label class="editlabel">常用比例</label>
                                <input type="text" class="edit-input" />
                            </div>
                            <div class="editpage-input">
