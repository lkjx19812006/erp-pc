	    ...
	    <div class="model-header">
			...
			<div class="trans_service clearfix">
	            ...
	            <table class="table table-hover table_head table-striped " v-cloak>
	                ...
	                <tbody>
	                    <tr v-for="item in initDistrictlist">
	                    	<td  @click.stop="">
	                           <label  class="checkbox_unselect" v-bind:class="{'checkbox_unselect':!item.checked,'checkbox_select':item.checked}"  @click="selectDistrict($index,item.id,item.cname)" ></label>
	                        </td>
	                        <td>{{item.cname}}</td>
	                        <td></td>
	                    </tr>
...
export default{
	...
	methods:{
		selectDistrict:function(index,id,cname){
			...
			this.$dispatch('district',this.param);
		},
