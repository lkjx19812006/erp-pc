                ...
                <div class="edit-model">
                    ...
                    <section class="editsection">
                        ...
                        <div class="clearfix">
                            ...
                            <div class="editpage-input col-md-4">
                                <label class="editlabel" v-if="param.type==1">{{$t('static.consignee_name')}}
                                    <!-- <span class="system_danger" v-if="$validation.consignee.minlength">{{$t('static.enter_name')}}</span> --></label>
                            ...
                            <div class="editpage-input col-md-4">
                                ...
                                <div v-if="city.cnameEn" type="text" class="edit-input">
                                    <v-select :debounce="250" :value.sync="district" :options="initDistrictlist" placeholder="区/District" label="cname">
                                    </v-select>
                                </div>
                            </div>
                        ...
                        <validator name="inner">
                            <div v-if="addParam.show||updateParam.show" class="editpage" style="border:1px solid #AAAAAA;padding:5px 10px;border-radius:5px;margin-top:25px">
                                <div class="clearfix col-md-12">
                                    ...
                                    <!-- 价格,必填至多两位小数 -->
                                    <div class="editpage-input col-md-6">
                                        <label class="editlabel">{{$t('static.price')}}
...
export default {
    ...
    created() {
        ...
        if (this.param.country) {
            ...
            this.city.cnameEn = this.param.cityName;
