...
.track-rcol{width: 600px; border: 1px solid #eee;}
...
.track-list li .node-icon{position: absolute; left: -6px; top: 50%; width: 11px; height: 11px; background: url(/static/images/order-icons.png)  -21px -72px no-repeat;}
