            ...
            <table class="table table-hover table_color table-striped " v-cloak>
                ...
                <tbody>
                    ...
                    <tr v-for="item in initIntlIntentionInquireList" style="cursor:pointer">
                        ...
                        <td><div v-if="item.inquire==1||item.inquire==2" style="display:inline-block;margin-right:7px" @click="confirmOffer(item.intentionId,$index)"><img src="/static/images/confirmOffer.png" alt="确认报价"  /></div></td>
                    </tr>
