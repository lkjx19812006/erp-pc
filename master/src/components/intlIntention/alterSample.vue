		    ...
		    <validator name="validation">
		        <div class="edit-model">
	                       ...
	                       <div v-if="addParam.show||updateParam.show" class="editpage" style="border:1px solid #AAAAAA;padding:5px 10px;border-radius:5px;margin-top:25px">
	                             <div class="clearfix">
	                                ...
	                                <div class="editpage-input col-md-6">
	                                     ...
	                                     <select v-model="breedInfo.eunit" class="form-control edit-input" v-validate:unit="{required:true}" @change="test()">
	                ...
	                <section class="editsection clearfix">
	                	<h4 style="text-align: left;">{{$t('static.customer_info')}}</h4>
	                	<div class="client-detailInfo col-md-6 col-xs-12">
	                        <label class="editlabel">{{$t('static.client_name')}} <span class="system_danger" v-if="$validation.customer.required">{{$t('static.required')}}</span></label>
	                    ...
	                    <div class="client-detailInfo  col-md-6 col-xs-12">
	                        <label class="editlabel">{{$t('static.consignee_name')}}（若为空则默认收货人为客户本人）</label>
	                        <input type="text" class="form-control edit-input" v-model="param.consignee" value="{{param.consignee}}"  />
	                    </div>
	                    <div class="client-detailInfo  col-md-6 col-xs-12">
	                        <label class="editlabel">{{$t('static.consignee_phone')}}</label>
