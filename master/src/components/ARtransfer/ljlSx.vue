<style scoped>
  * {
  ...
  .ljlSx .search-filter .form-item:nth-child(4){
    flex: 0 0 200px;
    justify-content: space-between;
  }
  .ljlSx .search-filter .form-item label {
    margin-right: 10px;
  }

  /*录入按钮开始*/

  .ljlSx .input-info-btn {
    display: flex;
    flex-direction: row;
  ...
  .ljlSx .top-search .detail-item span {
    margin-right: 10px;
  }
  .ljlSx .top-search .detail-item:nth-child(4){
    flex: 0 0 auto;
    width: 135px;
    justify-content: space-between;
  }
 ...
 .ljlSx  .my-wrap {
  ...
  .ljlSx  .my-wrap .demo-spin-icon-load{
