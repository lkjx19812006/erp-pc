                ...
                <section class="editsection" v-cloak>
                    ...
                    <div class="clearfix">
                        <div class="client-detailInfo pull-left col-md-6 col-xs-12">
                            ...
                            <input type="text" class="form-control edit-input" id="name" v-model="param.breedName" v-validate:name="['required']" @click="searchBreed(param.breedName,param.breedId)" />
                        </div>
