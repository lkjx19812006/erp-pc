                    ...
                    <section class="editsection" v-cloak>
                         ...
                         <div class="clearfix">
                            <div class="client-detailInfo pull-left col-md-6 col-xs-12">
                                <label class="editlabel">客户手机号 <span class="system_danger" v-if="$validation.phone.required">请输入客户手机号</span></label>
                                 <input type="text" class="form-control edit-input"  id="phone" v-model="param.customerPhone" value="{{param.customerPhone}}" v-validate:phone="['required']" />
                            </div>
                            <div class="client-detailInfo pull-right col-md-6 col-xs-12">
                                <label class="editlabel">国家 <span class="system_danger" v-if="$validation.country.required">请输入国家名称</span></label>
                                <input type="text" class="form-control edit-input"  id="country" v-model="param.country" value="{{param.country}}" v-validate:country="['required']" />
                            </div>
                        </div>
                        <div class="clearfix">
                            <div class="client-detailInfo pull-left col-md-6 col-xs-12">
                                <label class="editlabel">所在省 <span class="system_danger" v-if="$validation.province.required">请输入省</span></label>
                                 <input type="text" class="form-control edit-input"  id="province" v-model="param.province" value="{{param.province}}" v-validate:province="['required']" />
                            </div>
                            <div class="client-detailInfo pull-right col-md-6 col-xs-12">
                                <label class="editlabel">所在市 <span class="system_danger" v-if="$validation.city.required">请输入市</span></label>
                                <input type="text" class="form-control edit-input"  id="city" v-model="param.city" value="{{param.city}}" v-validate:city="['required']" />
                            </div>
                        </div>
                        <div class="clearfix">
                            <div class="client-detailInfo pull-left col-md-6 col-xs-12">
                                <label class="editlabel">所在区 <span class="system_danger" v-if="$validation.district.required">请输入区</span></label>
                                 <input type="text" class="form-control edit-input"  id="district" v-model="param.district" value="{{param.district}}" v-validate:district="['required']" />
                            </div>
                            <div class="client-detailInfo pull-right col-md-6 col-xs-12">
                                <label class="editlabel">数量 <span class="system_danger" v-if="$validation.number.required">请输入数量</span></label>
                                <input type="text" class="form-control edit-input"  id="number" v-model="param.number" value="{{param.number}}" v-validate:number="['required']" />
                            </div>
                        </div>
                        <div class="clearfix">
                            <div class="client-detailInfo pull-left col-md-6 col-xs-12">
                            ...
                            <div class="client-detailInfo  pull-right col-md-6 col-xs-12">
                                ...
                                <input type="text" class="form-control edit-input"   v-model="param.qualification" value="{{param.qualification | qualify}}" />
                            </div>
                        </div>
                        <div class="clearfix">
                            <div class="client-detailInfo pull-left col-md-6 col-xs-12">
                                <label class="editlabel">规格  <span class="system_danger" v-if="$validation.spec.required">请输入规格</span></label>
                                <input type="text" class="form-control edit-input"  id="spec" v-model="param.spec" value="{{param.spec}}" v-validate:spec="['required']" />
                            </div>
                            <div class="client-detailInfo  pull-right col-md-6 col-xs-12">
                        ...
                        <div class="clearfix">
                            <div class="client-detailInfo pull-left col-md-6 col-xs-12">
                                ...
                                <input type="text" class="form-control edit-input"  id="address" v-model="param.address" value="{{param.address}}" v-validate:address="['required']" />
                            </div>
                            <div class="client-detailInfo  pull-right col-md-6 col-xs-12">
                                <label class="editlabel">预付比例 <span class="system_danger" v-if="$validation.address.required">请输入预付比例</span></label>
                                <input type="text" class="form-control edit-input"  v-model="param.advance" value="{{param.advance}}" id="advance"  v-validate:advance="['required']"/>
                            </div>
                        </div>
                        <div class="clearfix">
                            <div class="client-detailInfo pull-left col-md-6 col-xs-12">
