                        ...
                        <section class="editsection" v-cloak>
                            <div class="clearfix">
                                ...
                                <div class="client-detailInfo col-md-6">
                                    ...
                                    <input type="text" class="form-control edit-input" v-model="param.name" v-validate:name="{minlength:2}" />
                                </div>
                                <!-- 联系人姓名 -->
                                <div class="client-detailInfo  col-md-6">
                  ...
                  <option value='1,企业'>{{$t('static.enterprise')}}</option>
                                ...
                                <div v-if="!param.countryId" class="client-detailInfo  col-md-6">
                                    ...
                                    <div class="form-control edit-input" style="padding:0;border:none">
                                        <v-select :debounce="250" :value.sync="country" :on-change="selectProvince" :options="countryArr" placeholder="国家" label="cnameEn">
                                        </v-select>
                                    </div>
                                </div>
                                <!-- 选择省 -->
                                <div class="client-detailInfo  col-md-6">
                                    ...
                                    <div class="form-control edit-input" style="padding:0;border:none" v-if="country.id">
                                        <v-select :debounce="250" :value.sync="province" :on-change="selectCity" :options="provinceArr" placeholder="省" label="cname">
                                        </v-select>
                                    </div>
                                </div>
                                <!-- 选择市 -->
                                <div class="client-detailInfo   col-md-6">
                                    ...
                                    <div class="form-control edit-input" style="padding:0;border:none" v-if="province.cname">
                                        <v-select :debounce="250" :value.sync="city" :options="cityArr" placeholder="市" label="cname">
                                        </v-select>
                                    </div>
                                </div>
                                <!-- 主营业务 -->
...
export default {
    ...
    methods: {
        ...
        checkCustomer: function() { //检查客户是否存在
            var _self = this;
            var Phone = this.contacts[0].phone.replace(/(^\s*)|(\s*$)/g, "");
            this.$http({
                method: 'POST',
                ...
                if (this.contacts[0].phone.length >= 7 && this.contacts[0].phone.length <= 45 && res.json().code == 200) {
