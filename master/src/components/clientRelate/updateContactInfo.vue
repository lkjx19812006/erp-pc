                        ...
                        <div class="editpage" v-cloak>
                            <div class="editpageleft">
                                ...
                                <div class="editpage-input">
                                    ...
                                    <input type="text" class="form-control edit-input" v-model="param.department" value="{{param.department}}" />
                                </div>
                                 <div class="editpage-input">
                             ...
                             <div class="editpageright">
                                ...
                                <div class="editpage-input">
                                    <label class="editlabel"><label class="editlabel" for="system">{{$t('static.wechat')}}<span class="system_danger" v-if="$validation.wechart.wechart">{{$t('static.validate_wechat')}}</span></label></label>
        ...
        save:function(){
            if(this.param.list&&this.param.list.length>0){   
                for(var i=0;i<this.param.list.length;i++){
                    if(this.param.sub!=i&&(this.param.list[i].name==this.param.name||this.param.list[i].phone==this.param.phone)){
